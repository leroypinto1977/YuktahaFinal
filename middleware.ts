...
//   ) {
//     try {
//       // Get the user from Kinde auth
//       const kindeUser = await getUser(req);

//       if (!kindeUser || !kindeUser.email) {
//         // Redirect to login if no user or email
//         return NextResponse.redirect(new URL("/api/auth/login", req.url));
//       }
...
//       const user = await UserDetails.findOne({ email: kindeUser.email });

...
// // Mobile Event Card Component - Now Vertical
...
//       className="w-full"
//     >
//       <Card className="bg-zinc-900 border-zinc-800 border-2 rounded-2xl overflow-hidden shadow-lg mx-auto mb-4 h-full flex flex-col">
...
// // Desktop Event Card Component - Unchanged
...
//   // Modified mobile view rendering logic - check if it's non-technical events
//   if (isMobile && !isModalView) {
//     // For technical events, keep the horizontal scroll layout
...
//     // For non-technical events, use vertical card layout
//     return (
...
//           className="pb-2"
//         >
//           <h3 className="text-white font-medium text-lg mb-4">Browse Events</h3>
...
// Mobile Event Card Component - With scroll-based animations
const MobileEventCard = ({
  ...
  // For non-technical cards, use scroll-based animations
  ...
  // For technical cards, keep the original animation
  return (
    <motion.div
      key={event.eventid}
      initial={{ opacity: 0, y: 20 }}
...
// For the section container, to track overall scroll progress
const NonTechnicalMobileSection = ({ children }) => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="w-full px-4 py-8 bg-gradient-to-br from-neutral-800 to-neutral-900"
    >
      {children}

      {/* Scroll progress indicator */}
      <motion.div
        className="fixed bottom-4 right-4 w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center z-10"
...
const EventGrid = ({
  ...
  if (isMobile && !isModalView) {
    ...
    // For non-technical events, use vertical card layout with scroll-based animations
    return (
      <NonTechnicalMobileSection>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5 }}

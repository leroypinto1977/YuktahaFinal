...
//             </motion.div>
//             <div className="relative w-full h-screen">
//               {/* Scroll Down Text Animation - Vertically oriented on right side */}
//               <motion.div
...
//                 }}
//                 transition={{
//                   x: { delay: isMobile ? 1.5 : 2, duration: 0.8 },
//                   y: {
...
//                     repeatType: "reverse",
//                   },
//                   opacity: { delay: isMobile ? 1.5 : 2, duration: 0.8 },
//                 }}
//                 className="absolute right-6 md:right-12 bottom-32 md:bottom-40 z-30 origin-bottom-right"
//               >
//                 <h2 className="text-gray-500 font-sofia text-sm xs:text-base sm:text-lg md:text-xl font-medium transform rotate-90 whitespace-nowrap">
//                   Scroll Down
//                 </h2>
//               </motion.div>

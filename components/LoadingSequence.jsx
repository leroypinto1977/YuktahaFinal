...
//             >
//               <BackgroundGradientCard className="py-3 xs:py-4 sm:py-5 md:py-10" />
//             </motion.div>
//             <motion.div
//               initial={{ opacity: 0, y: 30 }}
//               whileInView={{ opacity: 1, y: 0 }}
...
// const ScrollBasedSection = ({ children, className }) => {
...
//   return (
//     <motion.div ref={sectionRef} style={{ opacity, y }} className={className}>
//       {children}
//     </motion.div>
//   );
// };
...
//           <ScrollBasedSection className="mt-4">
...
//           <div className="py-5 xs:py-8 sm:py-10 md:py-20 px-2 xs:px-3 sm:px-4 md:px-20 flex flex-col md:flex-row justify-center items-center space-y-4 xs:space-y-6 sm:space-y-8 md:space-y-0">
//             <ScrollBasedSection className="px-2 xs:px-3 sm:px-4 md:px-20 w-full md:w-auto">
//               <BackgroundGradientCard className="py-3 xs:py-4 sm:py-5 md:py-10" />
//             </ScrollBasedSection>
